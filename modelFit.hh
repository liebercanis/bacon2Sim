...
class modelFit
{
  public:
    ...
    double PPM[NSETS]={.1,1,2,5,10,100,1000,1000,1000,1000};
...
modelFit::modelFit(int ifit, int iset) 
{
  ...
  fp = new TF1(Form("ModelFit-%.2f-type-%i-set-%i",ab,ifit,iset),lightModel,0.,xMax, NPARS);
